...
function EntitySheet({ detail, onClose, onRelated }: { detail: EntityDetail; onClose: () => void; onRelated: (type: EntityType, id: string) => void }) {
  ...
  return <>
    ...
    <div className="detail-scroll">
      ...
      {isParcelLike && <section className="detail-section"><p className="detail-note unit-scope">Objet analysé : une parcelle cadastrale, pas un bien. Un bien peut s’étendre sur plusieurs parcelles, et aucune source autorisée ne permet de les réunir.</p></section>}
