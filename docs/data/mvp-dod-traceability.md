...
| Pipelines partitionnés 22/29/35/56 | partitions Dagster release × département pour toutes les sources importées ([BUG-02](../backlog/BUG-02-scripts-import-hors-dagster.md), [BUG-19](../backlog/BUG-19-imports-restants-hors-dagster.md), [BUG-20](../backlog/BUG-20-imports-multi-assets-hors-dagster.md)) | validé, matérialisé sur le 35 seulement ; DS-08 reprend son lot sans le reproduire, faute de checksum à la source |
