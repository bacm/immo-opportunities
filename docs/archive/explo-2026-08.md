> **Document historique.** Brainstorm d'août 2026, antérieur à `SPEC.md`. Conservé tel quel ; il ne décrit ni le produit ni le dépôt actuels. La référence est [ADR-016](../decisions/ADR-016-intelligence-de-marche-puis-radar.md).
