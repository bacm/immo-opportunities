...
| [D2](./D2-import-gpu-ds08.md) | DS-08 GPU : zonage et contraintes, sans interprétation de règlement | v0.5 | D1 | M | En cours | en cours |
| [D2b](./D2b-profils-de-regles.md) | Profils de règles d'urbanisme, là où un candidat le justifie | v0.6 | D2, E3 | L | À faire | attend D2, E3 |
...
| [D6a](./D6a-verification-mutations-parcelle.md) | Voir les mutations d'une parcelle, pour vérifier que DVF tient | v0.5 | D1 | S | En cours | en cours |
...
**20/51 terminés.** Prêts à démarrer : A1, BUG-02, BUG-08, BUG-11, D3, D4, D7, G6, G7.
...
- **D2** — pipelines/scripts/compute_urban_features.py, pipelines/scripts/import_gpu_release.py, pipelines/src/immo_pipelines/market_data/cnig.py, contracts/datasets/DS-08/, docs/data/gpu-coverage-35.md
- **D6a** — backend/src/immo/explorer.py, backend/src/immo/api/routes/explorer.py, apps/web/src/App.tsx, docs/data/dvf-verification-35.md
