...
| [D8](./D8-historique-dvf-2014.md) | Remonter l'historique DVF à 2014, depuis les publications DGFiP archivées | v0.5 | D1 | L | En cours | en cours |
...
**38/68 terminés.** Prêts à démarrer : A6, BUG-02, BUG-08, BUG-11, BUG-13, D7, G6, G7.
...
- **D8** — contracts/datasets/DS-06/, pipelines/src/immo_pipelines/market_data/, pipelines/scripts/import_dvf_release.py, docs/data/dvf-quality-35.md
