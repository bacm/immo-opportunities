...
| [BUG-08](./BUG-08-cycle-de-vie-des-releases-remplacees.md) | Une release remplacée n'est jamais retirée | dette transverse | — | M | Terminé | — |
...
| [BUG-13](./BUG-13-sujet-des-features-batiment.md) | Une feature de bâtiment ne peut se poser que sur un enregistrement, pas sur un bâtiment | dette transverse | — | M | Terminé | — |
...
| [H2](./H2-barometre-document-publiable.md) | Mettre en forme le baromètre : un document publiable par EPCI, hors plateforme | V5 | H1 | M | Terminé | — |
| [H3](./H3-entretiens-professionnels-barometre.md) | Présenter le baromètre à cinq professionnels, et recueillir ce qu'ils paieraient | V5 | H2 | M | À faire | **verrou humain** |
