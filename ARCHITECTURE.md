...
DPE par parcelle, recherche d'un DPE par numéro écarts d'import compris (C7), pastille de couverture avec infobulle, revue B4 dans un `<dialog>` modal. Deux colonnes, carte
